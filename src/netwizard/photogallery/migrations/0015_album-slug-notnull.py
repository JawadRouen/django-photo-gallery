...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('photogallery_album', 'slug', models.SlugField(max_length=255, unique=True))
    
    
    def backwards(self, orm):
        "Write your backwards migration here"
        db.alter_column('photogallery_album', 'slug', models.SlugField(max_length=255, unique=True, blank=True, null=True))
