...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.display_order'
        db.add_column('photogallery_album', 'display_order', models.PositiveIntegerField(default=0, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Album.display_order'
        db.delete_column('photogallery_album', 'display_order')
